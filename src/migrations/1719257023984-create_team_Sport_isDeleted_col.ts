...
export class CreateTeamSportIsDeletedCol1719257023984 implements MigrationInterface {
    name = 'CreateTeamSportIsDeletedCol1719257023984'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "team" ("team_id" int NOT NULL IDENTITY(1,1), "team_name" nvarchar(255) NOT NULL, "team_type" nvarchar(255) NOT NULL CONSTRAINT "DF_0026a25610d4e56b8cd5fcab822" DEFAULT 'candidates', "below_age" int NOT NULL, "matches_won" int NOT NULL, "matches_lost" int NOT NULL, "isDeleted" bit NOT NULL, "sportSportId" int, CONSTRAINT "PK_a35a345d4436b82adf6bb76f3ce" PRIMARY KEY ("team_id"))`);
