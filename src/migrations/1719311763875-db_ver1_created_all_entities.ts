...
export class DbVer1CreatedAllEntities1719311763875 implements MigrationInterface {
    name = 'DbVer1CreatedAllEntities1719311763875'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "match" ("match_id" int NOT NULL IDENTITY(1,1), "match_type" nvarchar(50) NOT NULL, "date_held" date NOT NULL, "match_duration" int NOT NULL, "pending" bit NOT NULL CONSTRAINT "DF_c705fae408c70ef24a5a97e538e" DEFAULT 1, "is_deleted" bit NOT NULL CONSTRAINT "DF_22a542498dfa76e38b506b73ee9" DEFAULT 0, "sportSportId" int, "tournamentTournamentId" int, CONSTRAINT "PK_2e7d516f3dc97d9e2f882212d2b" PRIMARY KEY ("match_id"))`);
        await queryRunner.query(`CREATE TABLE "tournament" ("Tournament_id" int NOT NULL IDENTITY(1,1), "title" nvarchar(120) NOT NULL, "date_held" date NOT NULL, "matchMatchId" int, CONSTRAINT "PK_d3866f302171d87aa75a13f8179" PRIMARY KEY ("Tournament_id"))`);
        await queryRunner.query(`CREATE TABLE "sponsor" ("sponsor_id" int NOT NULL IDENTITY(1,1), "brand_name" nvarchar(75) NOT NULL, "is_deleted" bit NOT NULL CONSTRAINT "DF_e7275a819af5477f6a37e14e1b6" DEFAULT 0, CONSTRAINT "PK_2c853dd361a7c851f48f2f954b5" PRIMARY KEY ("sponsor_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "team_member" ("id" int NOT NULL IDENTITY(1,1), "match_role" nvarchar(100) NOT NULL, "goals" int NOT NULL, "saves" int NOT NULL, "assists" int NOT NULL, "salary" numeric(7,2) NOT NULL, "user_id" int, "teamTeamId" int, CONSTRAINT "PK_649680684d72a20d279641469c5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user" ("user_id" int NOT NULL IDENTITY(1,1), "role" nvarchar(255) NOT NULL, "firstName" nvarchar(255) NOT NULL, "lastName" nvarchar(255) NOT NULL, "dob" datetime NOT NULL, "job" nvarchar(255) NOT NULL, "reports_from" int NOT NULL, "reported_on" int NOT NULL, "isDeleted" bit NOT NULL, CONSTRAINT "PK_758b8ce7c18b9d347461b30228d" PRIMARY KEY ("user_id"))`);
        await queryRunner.query(`CREATE TABLE "coach" ("coach_id" int NOT NULL IDENTITY(1,1), "salary" numeric(7,2) NOT NULL, "user_id" int, "coachingTeamTeamId" int, CONSTRAINT "PK_79a8206bc16eaf7ea2b4fc02749" PRIMARY KEY ("coach_id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "REL_1f2795aa1fb31dd9444f96aa80" ON "coach" ("user_id") WHERE "user_id" IS NOT NULL`);
        await queryRunner.query(`CREATE UNIQUE INDEX "REL_76b6a412907d2a6b13a8435c95" ON "coach" ("coachingTeamTeamId") WHERE "coachingTeamTeamId" IS NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "match" ADD CONSTRAINT "FK_f64073da09abc013b62256fb668" FOREIGN KEY ("sportSportId") REFERENCES "sport"("sport_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "match" ADD CONSTRAINT "FK_216d7823d83d7c038552dbb3aaf" FOREIGN KEY ("tournamentTournamentId") REFERENCES "tournament"("Tournament_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "team" ADD CONSTRAINT "FK_3c43702f4fa9af7a917cd006829" FOREIGN KEY ("sportSportId") REFERENCES "sport"("sport_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "team" ADD CONSTRAINT "FK_99574f16e2b0f4f2de38bf1c479" FOREIGN KEY ("teamMemberId") REFERENCES "team_member"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "team_member" ADD CONSTRAINT "FK_0724b86622f89c433dee4cd8b17" FOREIGN KEY ("user_id") REFERENCES "user"("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "team_member" ADD CONSTRAINT "FK_b13397bccd29fe3ffaaae10a7e6" FOREIGN KEY ("teamTeamId") REFERENCES "team"("team_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "coach" ADD CONSTRAINT "FK_76b6a412907d2a6b13a8435c957" FOREIGN KEY ("coachingTeamTeamId") REFERENCES "team"("team_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "coach" DROP CONSTRAINT "FK_76b6a412907d2a6b13a8435c957"`);
        ...
        await queryRunner.query(`ALTER TABLE "team" DROP CONSTRAINT "FK_99574f16e2b0f4f2de38bf1c479"`);
        ...
        await queryRunner.query(`DROP INDEX "REL_76b6a412907d2a6b13a8435c95" ON "coach"`);
